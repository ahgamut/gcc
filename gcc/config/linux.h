...
#ifdef SINGLE_LIBC
#define OPTION_GLIBC_P(opts)	(DEFAULT_LIBC == LIBC_GLIBC || DEFAULT_LIBC == LIBC_COSMO)
...
#else
#define OPTION_GLIBC_P(opts)	((opts)->x_linux_libc == LIBC_GLIBC || (opts)->x_linux_libc == LIBC_COSMO)
